...
const SelectStatusActivityModal = ({
  visible,
  onClose,
  handleStatus,
  valueStatus,
  ...
  const status = [
    { value: 'Abierta', label: 'Abrir' },
    { value: 'Cerrada', label: 'Cerrar' },
    { value: 'Cancelada', label: 'Cancelar' },
  ]

  const [valueSelected, setValueSelected] = useState(valueStatus)

  useEffect(() => {
    setValueSelected(valueStatus)
  }, [valueStatus])
...
export default SelectStatusActivityModal
