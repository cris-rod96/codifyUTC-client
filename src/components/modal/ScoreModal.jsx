...
const ScoreModal = ({ visible, onClose, handleQuestion }) => {
  const times = [
    { value: 25, label: '25 puntos (Muy Fácil)' },
    { value: 50, label: '50 puntos (Fácil)' },
    { value: 75, label: '75 puntos (Intermedio)' },
    { value: 100, label: '100 puntos (Díficil)' },
  ]
