  ...
  return courses && courses.length > 0 ? (
    classes && classes.length > 0 ? (
            ...
            renderItem={({ item, index }) => (
              ...
              >
                ...
                <View className="flex flex-col px-3 py-5">
                  ...
                  <View className="flex flex-row items-center justify-between gap-2 mt-3">
                    <View className="flex-1 py-3 px-2 flex flex-col justify-center items-center gap-1">
                      <Text
                        style={{
                          fontFamily: 'Jost_600SemiBold',
                          fontSize: 15,
      ...
      <View className="flex-1 bg-[#F5F9FF] justify-center items-center px-5">
        ...
        >
          Para añadir una actividad, necesitas crear una clase a tu curso.
        </Text>

        <TouchableOpacity
          className="w-full py-4 bg-[#741D1D] rounded-full flex flex-row items-center justify-center mt-5"
          onPress={() => navigation.navigate('TabClass')}
        >
          <Text
            style={{
              fontFamily: 'Jost_600SemiBold',
    ...
    <View className="flex-1 bg-[#F5F9FF] justify-center items-center px-5">
      ...
      >
        Necesitas crear un curso para poder añadir actividades
      </Text>
