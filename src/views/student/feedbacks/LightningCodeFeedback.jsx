...
const LightningCodeFeedback = ({ route, navigation }) => {
          ...
          <View className="flex-1 flex-col w-full mt-5">
            {userAnswers.map((answer, index) => (
              ...
              >
                ...
                <View className="mt-5 w-full h-[200px] bg-[#282C34] rounded-lg py-3 px-5">
                  <Text
                    style={{
                      fontFamily: 'Mulish_600SemiBold',
                      fontSize: 14,
...
export default LightningCodeFeedback
